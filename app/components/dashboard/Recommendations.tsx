...
import { Leaf, Bus, Lightbulb, Zap, Car, Construction} from 'lucide-react';

export function Recommendations() {
  return (
    <><Card className="p-4">
      <h3 className="font-semibold mb-4">Do you know?</h3>
      <ul className="space-y-4">
        <li className="flex items-start space-x-3">
          <Zap className="h-5 w-5 text-green-500 mt-0.5" />
          <p>Electricity and heat cause 29.7% of emissions.</p>
        </li>
        <li className="flex items-start space-x-3">
          <Car className="h-5 w-5 text-green-500 mt-0.5" />
          <p>Transportation cause 13.7% of emission.</p>
        </li>
        <li className="flex items-start space-x-3">
          <Construction className="h-5 w-5 text-green-500 mt-0.5" />
          <p>manufacturing and construction cause 12.7% of emission.</p>
        </li>
      </ul>
    </Card><Card className="mt-5 p-4">
